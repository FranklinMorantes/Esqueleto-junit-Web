...
public class DemoBase
{
	...
	/*
	 * public WebDriver chromeDriverConnection() { // SETEAR LAS OPCIONES DE
	 * NAVEGADOR ChromeOptions chromeOptions = new ChromeOptions();
	 * chromeOptions.setPageLoadStrategy(PageLoadStrategy.NORMAL);
	 * 
	 ...
	 * ChromeDriver();
	 * 
	 * // MAXIMIZAR NAVEGADOR driver.manage().window().maximize(); return driver; }
	 */
